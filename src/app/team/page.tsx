      ...
      <section className=" bg-base-100">
        <div className="container px-6 py-10 mx-auto">
          ...
          <p className="max-w-2xl mx-auto my-6 text-center text-gray-500">
            Welcome to Trurock Wealth – Elevating Your Financial Journey to Success. Trurock
            Wealth is a leading financial advisory firm committed to tailored solutions and
            unwavering integrity. Our seasoned professionals prioritize your unique goals,
            offering expert guidance across diverse financial services. Trust us to navigate the
            complexities, ensuring your financial plan remains responsive and resilient. Welcome
            to a partnership dedicated to securing your financial future.
          </p>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
            <div className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-secondary ">
              ...
              <p className="mt-4 text-gray-500 capitalize group-hover:text-white">
                ...
                communication, critical thinking, and leadership experience make him an
                intelligent yet empathetic advisor. A keen listener with an eye for detail, he
                brings creativity and thoughtfulness to exploring new ideas in the dynamic
                financial industry.
              </p>
            ...
            <div className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-secondary ">
              ...
              <p className="mt-4 text-gray-500 capitalize group-hover:text-white">
                ...
                business and technology. His expertise lies in blending innovation with
                practicality to create digital experiences that stand out in today&apos;s dynamic
                landscape.
              </p>
            ...
            {/* <div className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-secondary ">
              ...
              <p className="mt-4 text-gray-500 capitalize group-hover:text-gray-300">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum nesciunt officia
                aliquam neque optio? Cumque facere numquam est.
              </p>
