    ...
    <section className="bg-white dark:bg-gray-900 pb-5 lg:px-10">
      <div className="container px-6 py-10 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
          <div className="p-8 space-y-3 border-2 border-secondary dark:border-blue-300 rounded-xl">
            <span className="inline-block text-secondary dark:text-blue-400">
              <svg
            ...
            <a
              href="#"
              className="inline-flex p-2 text-secondary capitalize transition-colors duration-300 transform bg-blue-100 rounded-full rtl:-scale-x-100 dark:bg-blue-500 dark:text-white hover:underline hover:text-blue-600 dark:hover:text-secondary"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 h-6"
          ...
          <div className="p-8 space-y-3 border-2 border-secondary dark:border-blue-300 rounded-xl">
            ...
            <a
              href="#"
              className="inline-flex p-2 text-secondary capitalize transition-colors duration-300 transform bg-green-100 rounded-full rtl:-scale-x-100 dark:bg-blue-500 dark:text-white hover:underline hover:text-blue-600 dark:hover:text-secondary"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 h-6"
